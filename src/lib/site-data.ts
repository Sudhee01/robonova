...
export const events: ClubEvent[] = [
...
},
  {
    ...
    status: "completed",
    desc: "An electrifying combat robotics competition where teams design and build battle-ready robots to outlast opponents in the arena. Test your engineering skills, strategy and nerves in head-to-head elimination rounds. Open to all engineering students.",
    highlights: [
    "Head-to-head elimination format",
    "Weight and size regulations apply — rulebook shared on registration",
    "Robots must be built by the participating team",
    "Bring your own tools and spare parts",
    "Winners receive trophies and certificates",
    ],
    registrationUrl: "/contact",
  },
  {
    ...
    category: "Competition",
    status: "completed",
    desc: "A high-speed drone racing competition where pilots navigate custom-built quadcopters through a challenging obstacle course. Combines engineering precision with real-time piloting skills. Open to all MITE students.",
    highlights: [
    "FPV and line-of-sight racing categories",
    "Drone must be assembled by the team — no RTF drones",
    "Safety gear and regulations strictly enforced",
    "Practice session available before the main event",
    "Winners receive trophies and certificates",
    ],
    registrationUrl: "/contact",
  },
